...
import heroImage from "../../public/assets/Wakanda Forever Image.jpg";
...
const HeroSection = () => {
  return (
    <div className="h-screen w-full">
      ...
      {/* Content Overlay */}
      <div className="relative z-30 h-full flex flex-col justify-end px-5 py-12 gap-5">
        ...
        <div className="flex text-white gap-5">
          <button className="bg-[#0C3D78] p-3 rounded-full">Play</button>
